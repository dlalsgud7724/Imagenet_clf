...
class conv_block(tf.keras.Model):
    def __init__(self, filters, strides=(2, 2)):
        ...
        self.conv1 = tf.keras.layers.Conv2D(self.filters1, (3, 3), strides=strides)
        ...
        self.shortcut_conv = tf.keras.layers.Conv2D(self.filters1, (3, 3), strides=strides)
...
class identity_block(tf.keras.Model):
    def __init__(self, filters):
        ...
        self.conv1 = tf.keras.layers.Conv2D(self.filters1, (3, 3), strides=(1, 1), padding='same')
        self.bn1 = tf.keras.layers.BatchNormalization()
        self.relu1 = tf.keras.layers.ReLU()
